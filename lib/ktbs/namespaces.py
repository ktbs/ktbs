...
.
    ...
    :hasAttributeRange
        ...
        rdfs:domain :AttributeType ;
        # TODO should we use owl:Datatype? define our onw Datatype class?
    .
...
:parallel a :BuiltinMethod ; rdfs:label "parallel"@en, "parallèle"@fr .
:serial   a :BuiltinMethod ; rdfs:label "serial"@en,   "séquentielle"@fr .
...
KTBS_NS_GRAPH = Graph()
KTBS_NS_GRAPH.load(StringIO(KTBS_NS_TTL), URIRef(KTBS_NS_URI), "n3")
