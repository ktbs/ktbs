...
class TestFilter(KtbsTestCase):
    ...
    def test_filter_temporal(self):
        ...
        assert get_custom_state(ctr, 'last_seen') == unicode(o10.uri)
        ...
        assert get_custom_state(ctr, 'last_seen') == unicode(o15.uri)
        ...
        assert get_custom_state(ctr, 'last_seen') == unicode(o20.uri)
    ...
    def test_filter_otypes(self):
        ...
        assert len(ctr.obsels) == 2
        assert get_custom_state(ctr, 'last_seen') == unicode(o05.uri)
        ...
        assert len(ctr.obsels) == 4
        assert get_custom_state(ctr, 'last_seen') == unicode(o25.uri)
        assert get_custom_state(ctr, 'last_seen_b') == 25
        self.log.info(">strictly temporally monotonic change: add o30")
        o30 = src.create_obsel("o30", otype1, 30)
        assert len(ctr.obsels) == 5
        assert get_custom_state(ctr, 'last_seen') == unicode(o30.uri)
        ...
        assert get_custom_state(ctr, 'last_seen') == unicode(o35.uri)
